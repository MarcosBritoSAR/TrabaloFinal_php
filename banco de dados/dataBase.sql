...
--
-- Host: 127.0.0.1
-- Tempo de geração: 04/07/2023 às 18:06
...
(50, '2023-07-19', '2025-07-08', 'CASAMENTO', 2, 'O amor não se vê com os olhos, mas com o coração.');
...
--
ALTER TABLE `arquivo`
  ADD CONSTRAINT `FOREIGN KEY` FOREIGN KEY (`id_evento`) REFERENCES `evento` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
