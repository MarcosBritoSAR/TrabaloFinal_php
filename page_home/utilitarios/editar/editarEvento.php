...
$evento = buscaEventoEditavel($id_evento);
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<body>
    ...
    <div class="cadastro">
        <form class="formulario-cadastro" action="atualizar_evento.php?id_evento=<?php echo $id_evento;?>" method="post" enctype="multipart/form-data">
            <input type="hidden" name="id_usuario" value="<?php echo $result[0]['id']; ?>">

            <span>
                <label for="nome">Ocasião</label>
                <input type="text" name="name" value="<?php echo $evento[0]['nome']; ?>" required>
            </span>

            <span>
                <label for="data-inicio">Data de inicio</label>
                <input type="date" name="data-inicio" value="<?php echo $evento[0]['data_registro']; ?>" required>
            </span>
            ...
            <span>
                ...
                <input value='0' type="number" name="dias">
                <br>
                <label for="meses">Meses: </label>
                <input value='0' type="number" name="meses">
                <br>

                <label for="anos">Anos: </label>
                <input value='0' type="number" name="anos">
            </span>

            <span class="container-mensagem">
                <label for="mensagem">Deixe uma mensagem!(Máximo de 500 caracteres)</label>
                <br>
                <textarea  cols="50" rows="10" name="mensagem" id="mensagem"><?php echo $evento[0]['mensagem']; ?></textarea>
            </span>
            <span class="upload">
